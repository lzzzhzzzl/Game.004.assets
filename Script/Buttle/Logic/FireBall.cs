...
public class FireBall : MonoBehaviour, IButtle
{
    public float speed;
    ...
    {
        if (other.GetComponent<EnemyBaseController>())
        {
            other.GetComponent<EnemyBaseController>().HurtState(buttleDamage, gameObject.transform);
